  ...
  Widget build(BuildContext context) {
    return const Column(
      ...
      children: [
        ...
        AnimatedLinearProgressIndicator(percentage: 0.90, title: 'Getx',image: 'assets/icons/dart.png'),
        AnimatedLinearProgressIndicator(percentage: 0.93, title: 'Provider',image: 'assets/icons/dart.png'),
        AnimatedLinearProgressIndicator(percentage: 0.80, title: 'Bloc',image: 'assets/icons/dart.png'),
        AnimatedLinearProgressIndicator(percentage: 0.80, title: 'Go-Routes',image: 'assets/icons/dart.png'),
        AnimatedLinearProgressIndicator(percentage: 0.90, title: 'Payment-Gateway',image: 'assets/icons/dart.png'),
      ],);
  }
}
