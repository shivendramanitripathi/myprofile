  ...
  Widget build(BuildContext context) {
    return const Column(
      ...
      children: [
        ...
        AnimatedLinearProgressIndicator(percentage: 0.90, title: 'Provider',image: 'assets/icons/dart.png'),
        AnimatedLinearProgressIndicator(percentage: 0.89, title: 'Bloc',image: 'assets/icons/dart.png'),
      ],);
  }
}
